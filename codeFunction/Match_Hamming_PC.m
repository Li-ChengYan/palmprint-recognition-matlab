function [dis] = Match_Hamming_PC(P,Q)
% Compute the Hamming distance between two PC features.
% Input:
%     P - 32x64 binary feature matrix (left 32x32 real part, right 32x32 imaginary part)
%     Q - 32x64 binary feature matrix
% Output:
